...
with tab1:
    fig_ind8 = px.bar(ind8, x='Total CSE-Trained Educators', y='LGU',
                    orientation='h', title='Number of CSE-Trained Educators in KOICA Sites in Samar (2023)')
...
with tab2:
    fig_ind8 = px.bar(ind8, x='CSE-Trained Female Educators', y='LGU',
                    orientation='h', title='Number of CSE-Trained Female Educators in KOICA Sites in Samar (2023)')
    fig_ind8.update_layout(yaxis={'categoryorder': 'total ascending'})
...
with tab3:
    fig_ind8 = px.bar(ind8, x='CSE-Trained Male Educators', y='LGU',
                    orientation='h', title='Number of CSE-Trained Male Educators in KOICA Sites in Samar (2023)')
    fig_ind8.update_layout(yaxis={'categoryorder': 'total ascending'})
