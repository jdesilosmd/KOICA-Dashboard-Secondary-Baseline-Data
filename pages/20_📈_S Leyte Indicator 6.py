...
facility_list = pd.read_excel(facility_link, sheet_name='Southern Leyte')
...
st.header('Indicator 6: Number of Adolescent-Friendly Health Facilities in Southern Leyte')
...
with st.expander('Click to see AFHF data table'):
    st.markdown('###### % Number of Adolescent-Friendly Health Facilities in Southern Leyte')
