...
ind2a = pd.read_excel(data_link, sheet_name='FBD Maternal Residence')
ind2b = pd.read_excel(data_link, sheet_name='FBD Occurrence')
...
@st.cache_resource
def FBD_10_14(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Health Facility', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Birth (10-14 years) Done in a Health Facility<br>in {} (2012-2021)'.format(lgu))
...
def FBD_10_14_forecast(df, lgu):
    ...
    extrapolated1 = {'Year': xnew, 'Predicted Value': ynew} 
...
@st.cache_resource
def FBD_15_19(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Health Facility', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Birth (15-19 years) Done in a Health Facility<br>in {} (2012-2021)'.format(option_table))
...
@st.cache_resource
def Home_10_14(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Home', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Home Deliveries (10-14 years)<br>in {} (2012-2021)'.format(lgu))
...
@st.cache_resource
def Home_10_14_forecast(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Home', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Home Deliveries (10-14 years)<br>in {} (2012-2021)'.format(lgu))
...
@st.cache_resource
def Home_15_19(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Home', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Home Deliveries (15-19 years)<br>in {} (2012-2021)'.format(option_table))
...
@st.cache_resource
def Home_15_19_forecast(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Home', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Home Deliveries (15-19 years)<br>in {} (2012-2021)'.format(option_table))
...
def Others_10_14(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Others', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Birth (10-14 years) Done Neither in a<br>Health Facility nor at Home<br>in {} (2012-2021)'.format(lgu))
...
def Others_15_19(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Others', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Birth (15-19 years) Done Neither in a<br>Health Facility nor at Home<br>in {} (2012-2021)'.format(option_table))
...
def Not_Stated_10_14(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Not Stated', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Birth (10-14 years) Not Classified as to<br>Where the Delivery Occurred<br>in {} (2012-2021)'.format(lgu))
...
def Not_Stated_15_19(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Not Stated', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Birth (15-19 years) Not Classified as to<br>Where the Delivery Occurred<br>in {} (2012-2021)'.format(lgu))
...
@st.cache_resource
def FBD_bar_10_19(df, lgu, yrange=[0, 120]):
    fig_bar = px.bar(df.loc[df['LGU']==lgu,:], x='Year', y='Health Facility', template='seaborn',
                 color='Age Range', barmode='group',
                 title='Adolescent Birth (10-19 years) Done in a Health Facility<br>in {} (2012-2021, Actual Count)'.format(lgu))
...
def FBD_pct_bar_10_19(df, lgu, yrange=[0, 100]):
    fig_bar = px.bar(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Health Facility', template='seaborn',
                 color='Age Range', barmode='group',
                 title='Adolescent Birth (10-19 years) Done in a Health Facility<br>in {} (2012-2021, Percent)'.format(lgu))
...
def Home_bar_10_19(df, lgu, yrange=[0, 120]):
    fig_bar = px.bar(df.loc[df['LGU']==lgu,:], x='Year', y='Home', template='seaborn',
                 color='Age Range', barmode='group',
                 title='Adolescent Home Deliveries (10-19 years)<br>in {} (2012-2021, Actual Count)'.format(lgu))
...
def Home_pct_bar_10_19(df, lgu, yrange=[0, 100]):
    fig_bar = px.bar(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Home', template='seaborn',
                 color='Age Range', barmode='group',
                 title='Adolescent Home Deliveries (10-19 years)<br>in {} (2012-2021, Percent)'.format(lgu))
...
with ind2_tab1:      
    ...
    with st.expander('Please click to see the chart for the combined data of the 10 sites in this province'):
        ...
        fig_graph_10_14_all = px.scatter(maternal_10_14_all, x='Year', y='Percent Health Facility', template='seaborn',
                    trendline='ols', trendline_color_override='black',
                    title='Adolescent Birth (10-14 years) Done by a<br>Skilled Birth Attendant in Southern Leyte Sites (2012-2021, Percent)')
        
        fig_graph_15_19_all = px.scatter(maternal_15_19_all, x='Year', y='Percent Health Facility', template='seaborn',
                    trendline='ols', trendline_color_override='black',
                    title='Adolescent Birth (15-19 years) Done by a<br>Skilled Birth Attendant in Southern Leyte Sites (2012-2021, Percent)')
        fig_graph_10_19_all = px.bar(maternal_all, x='Year', y='Percent Health Facility', template='seaborn',
                                     color='Age Range',
                                     title='Adolescent Birth (10-19 years) Done by a<br>Skilled Birth Attendant in Southern Leyte Sites (2012-2021, Percent)')
    ...
    if option_table == 'Bontoc':
        ...
        if graph == 'Health Facility':
            ...
            if predict_check:
                FBD_10_14_forecast(df=maternal_10_14, lgu=option_table)
                FBD_15_19_forecast(df=maternal_10_14, lgu=option_table)
            else:
                FBD_10_14(df=maternal_10_14, lgu=option_table)
                FBD_15_19(df=maternal_15_19, lgu=option_table)
                FBD_bar_10_19(df=ind2a, lgu=option_table)
                FBD_pct_bar_10_19(df=ind2a, lgu=option_table)

        elif graph == 'Home':
            predict_check = st.checkbox('Click to see forecast up to 2026', key='checkbox_2')
            if predict_check:
                Home_10_14_forecast(df=maternal_10_14, lgu=option_table)
                Home_15_19_forecast(df=maternal_10_14, lgu=option_table)
            else:
                Home_10_14(df=maternal_10_14, lgu=option_table)
                Home_15_19(df=maternal_10_14, lgu=option_table)
                Home_bar_10_19(df=ind2a, lgu=option_table)
                Home_pct_bar_10_19(df=ind2a, lgu=option_table)
...
FBD_bar_10_19(df=maternal_all, lgu='Southern Leyte', yrange=[0, 600])
FBD_pct_bar_10_19(df=maternal_all, lgu='Southern Leyte')
Home_bar_10_19(df=maternal_all, lgu='Southern Leyte', yrange=[0, 600])
Home_pct_bar_10_19(df=maternal_all, lgu='Southern Leyte')
...
with ind2_tab2:      
    ...
    if option_occurrence == 'Bontoc':
        ...
        if graph == 'Health Facility':
            ...
            if predict_check:
                FBD_10_14_forecast(df=occurrence_10_14, lgu=option_table)
                FBD_15_19_forecast(df=occurrence_10_14, lgu=option_table)
            else:
                FBD_10_14(df=occurrence_10_14, lgu=option_table)
                FBD_15_19(df=occurrence_15_19, lgu=option_table)
                FBD_bar_10_19(df=ind2b, lgu=option_table)
                FBD_pct_bar_10_19(df=ind2b, lgu=option_table)

        elif graph == 'TBA':
            predict_check = st.checkbox('Click to see forecast up to 2026', key='checkbox_22')
            if predict_check:
                Home_10_14_forecast(df=occurrence_10_14, lgu=option_table)
                Home_15_19_forecast(df=occurrence_10_14, lgu=option_table)
            else:
                Home_10_14(df=occurrence_10_14, lgu=option_table)
                Home_15_19(df=occurrence_10_14, lgu=option_table)
                Home_bar_10_19(df=ind2b, lgu=option_table)
                Home_pct_bar_10_19(df=ind2b, lgu=option_table)
...
FBD_bar_10_19(df=occurrence_all, lgu='Southern Leyte', yrange=[0, 600])
FBD_pct_bar_10_19(df=occurrence_all, lgu='Southern Leyte')
Home_bar_10_19(df=occurrence_all, lgu='Southern Leyte', yrange=[0, 600])
Home_pct_bar_10_19(df=occurrence_all, lgu='Southern Leyte')
