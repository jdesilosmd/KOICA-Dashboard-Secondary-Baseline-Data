...
# ABR 10-14 Chart per LGU
    ...
    if option_abr_10_14_table == 'Bontoc':
        ...
        fig_abr_10_14_lgu = px.scatter(abr_10_14_melt.loc[abr_10_14_melt['LGU']=='Bontoc',:], x='Year', y='ABR', template='seaborn',
        ...
        fig_abr_10_14_lgu = px.scatter(abr_10_14_melt.loc[abr_10_14_melt['LGU']=='Libagon',:], x='Year', y='ABR', template='seaborn',
                                       trendline='ols', trendline_color_override='black',
                                       title='Adolescent Birth Rate (10-14 years) in {} (2012-2021)'.format(option_abr_10_14_table))
        fig_abr_10_14_lgu.update_traces(mode='lines')
        model = px.get_trendline_results(fig_abr_10_14_lgu)
        ...
        fig_abr_10_14_lgu = px.scatter(abr_10_14_melt.loc[abr_10_14_melt['LGU']=='Liloan',:], x='Year', y='ABR', template='seaborn',
        ...
        fig_abr_10_14_lgu = px.scatter(abr_10_14_melt.loc[abr_10_14_melt['LGU']=='Limasawa',:], x='Year', y='ABR', template='seaborn',
                                       trendline='ols', trendline_color_override='black',
                                       title='Adolescent Birth Rate (10-14 years) in {} (2012-2021)'.format(option_abr_10_14_table))
        fig_abr_10_14_lgu.update_traces(mode='lines')
        model = px.get_trendline_results(fig_abr_10_14_lgu)
        ...
        fig_abr_10_14_lgu = px.scatter(abr_10_14_melt.loc[abr_10_14_melt['LGU']=='Maasin',:], x='Year', y='ABR', template='seaborn',
                                       trendline='ols', trendline_color_override='black',
                                       title='Adolescent Birth Rate (10-14 years) in {} (2012-2021)'.format(option_abr_10_14_table))
        fig_abr_10_14_lgu.update_traces(mode='lines')
        model = px.get_trendline_results(fig_abr_10_14_lgu)
        ...
        fig_abr_10_14_lgu = px.scatter(abr_10_14_melt.loc[abr_10_14_melt['LGU']=='Macrohon',:], x='Year', y='ABR', template='seaborn',
                                       trendline='ols', trendline_color_override='black',
                                       title='Adolescent Birth Rate (10-14 years) in {} (2012-2021)'.format(option_abr_10_14_table))
        fig_abr_10_14_lgu.update_traces(mode='lines')
        model = px.get_trendline_results(fig_abr_10_14_lgu)
        ...
        fig_abr_10_14_lgu = px.scatter(abr_10_14_melt.loc[abr_10_14_melt['LGU']=='Malitbog',:], x='Year', y='ABR', template='seaborn',
                                       trendline='ols', trendline_color_override='black',
                                       title='Adolescent Birth Rate (10-14 years) in {} (2012-2021)'.format(option_abr_10_14_table))
        fig_abr_10_14_lgu.update_traces(mode='lines')
        model = px.get_trendline_results(fig_abr_10_14_lgu)
        ...
        fig_abr_10_14_lgu = px.scatter(abr_10_14_melt.loc[abr_10_14_melt['LGU']=='Padre Burgos',:], x='Year', y='ABR', template='seaborn',
                                       trendline='ols', trendline_color_override='black',
                                       title='Adolescent Birth Rate (10-14 years) in {} (2012-2021)'.format(option_abr_10_14_table))
        fig_abr_10_14_lgu.update_traces(mode='lines')
        model = px.get_trendline_results(fig_abr_10_14_lgu)
        ...
        fig_abr_10_14_lgu = px.scatter(abr_10_14_melt.loc[abr_10_14_melt['LGU']=='Sogod',:], x='Year', y='ABR', template='seaborn',
                                       trendline='ols', trendline_color_override='black',
                                       title='Adolescent Birth Rate (10-14 years) in {} (2012-2021)'.format(option_abr_10_14_table))
        fig_abr_10_14_lgu.update_traces(mode='lines')
        model = px.get_trendline_results(fig_abr_10_14_lgu)
        ...
        fig_abr_10_14_lgu = px.scatter(abr_10_14_melt.loc[abr_10_14_melt['LGU']=='Tomas Oppus',:], x='Year', y='ABR', template='seaborn',
                                       trendline='ols', trendline_color_override='black',
                                       title='Adolescent Birth Rate (10-14 years) in {} (2012-2021)'.format(option_abr_10_14_table))
        fig_abr_10_14_lgu.update_traces(mode='lines')
        model = px.get_trendline_results(fig_abr_10_14_lgu)
...
# ABR 15-19 Chart per LGU
    ...
    if option_abr_15_19_table == 'Bontoc':
        ...
        fig_abr_15_19_lgu = px.scatter(abr_15_19_melt.loc[abr_15_19_melt['LGU']=='Bontoc',:], x='Year', y='ABR', template='seaborn',
                                       trendline='ols', trendline_color_override='black',
        ...
        fig_abr_15_19_lgu = px.scatter(abr_15_19_melt.loc[abr_15_19_melt['LGU']=='Libagon',:], x='Year', y='ABR', template='seaborn',
                                       trendline='ols', trendline_color_override='black',
                                       title='Adolescent Birth Rate (15-19 years) in {} (2012-2021)'.format(option_abr_15_19_table))
        fig_abr_15_19_lgu.update_traces(mode='lines')
        model = px.get_trendline_results(fig_abr_15_19_lgu)
        ...
        fig_abr_15_19_lgu = px.scatter(abr_15_19_melt.loc[abr_15_19_melt['LGU']=='Liloan',:], x='Year', y='ABR', template='seaborn',
                                       trendline='ols', trendline_color_override='black',
                                       title='Adolescent Birth Rate (15-19 years) in {} (2012-2021)'.format(option_abr_15_19_table))
        fig_abr_15_19_lgu.update_traces(mode='lines')
        model = px.get_trendline_results(fig_abr_15_19_lgu)
        ...
        fig_abr_15_19_lgu = px.scatter(abr_15_19_melt.loc[abr_15_19_melt['LGU']=='Limasawa',:], x='Year', y='ABR', template='seaborn',
                                       trendline='ols', trendline_color_override='black',
                                       title='Adolescent Birth Rate (15-19 years) in {} (2012-2021)'.format(option_abr_15_19_table))
        fig_abr_15_19_lgu.update_traces(mode='lines')
        model = px.get_trendline_results(fig_abr_15_19_lgu)
        ...
        fig_abr_15_19_lgu = px.scatter(abr_15_19_melt.loc[abr_15_19_melt['LGU']=='Maasin',:], x='Year', y='ABR', template='seaborn',
                                       trendline='ols', trendline_color_override='black',
                                       title='Adolescent Birth Rate (15-19 years) in {} (2012-2021)'.format(option_abr_15_19_table))
        fig_abr_15_19_lgu.update_traces(mode='lines')
        model = px.get_trendline_results(fig_abr_15_19_lgu)
        ...
        fig_abr_15_19_lgu = px.scatter(abr_15_19_melt.loc[abr_15_19_melt['LGU']=='Macrohon',:], x='Year', y='ABR', template='seaborn',
                                       trendline='ols', trendline_color_override='black',
                                       title='Adolescent Birth Rate (15-19 years) in {} (2012-2021)'.format(option_abr_15_19_table))
        fig_abr_15_19_lgu.update_traces(mode='lines')
        model = px.get_trendline_results(fig_abr_15_19_lgu)
        ...
        fig_abr_15_19_lgu = px.scatter(abr_15_19_melt.loc[abr_15_19_melt['LGU']=='Malitbog',:], x='Year', y='ABR', template='seaborn',
                                       trendline='ols', trendline_color_override='black',
                                       title='Adolescent Birth Rate (15-19 years) in {} (2012-2021)'.format(option_abr_15_19_table))
        fig_abr_15_19_lgu.update_traces(mode='lines')
        model = px.get_trendline_results(fig_abr_15_19_lgu)
        ...
        fig_abr_15_19_lgu = px.scatter(abr_15_19_melt.loc[abr_15_19_melt['LGU']=='Padre Burgos',:], x='Year', y='ABR', template='seaborn',
                                       trendline='ols', trendline_color_override='black',
                                       title='Adolescent Birth Rate (15-19 years) in {} (2012-2021)'.format(option_abr_15_19_table))
        fig_abr_15_19_lgu.update_traces(mode='lines')
        model = px.get_trendline_results(fig_abr_15_19_lgu)
        ...
        fig_abr_15_19_lgu = px.scatter(abr_15_19_melt.loc[abr_15_19_melt['LGU']=='Sogod',:], x='Year', y='ABR', template='seaborn',
                                       trendline='ols', trendline_color_override='black',
                                       title='Adolescent Birth Rate (15-19 years) in {} (2012-2021)'.format(option_abr_15_19_table))
        fig_abr_15_19_lgu.update_traces(mode='lines')
        model = px.get_trendline_results(fig_abr_15_19_lgu)
        ...
        fig_abr_15_19_lgu = px.scatter(abr_15_19_melt.loc[abr_15_19_melt['LGU']=='Tomas Oppus',:], x='Year', y='ABR', template='seaborn',
                                       trendline='ols', trendline_color_override='black',
                                       title='Adolescent Birth Rate (15-19 years) in {} (2012-2021)'.format(option_abr_15_19_table))
        fig_abr_15_19_lgu.update_traces(mode='lines')
        model = px.get_trendline_results(fig_abr_15_19_lgu)
