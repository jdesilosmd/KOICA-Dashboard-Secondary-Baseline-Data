...
st.header('Indicator 2B:')
st.subheader('Number of Facility-Based Deliveries among adolescents aged 10-19 in UN-KOICA Sites in Samar')
...
def FBD_10_14(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Health Facility', template='seaborn',
                                 ...
                                 title='Adolescent Birth (10-14 years) Done in a Health Facility in {} (2012-2021)'.format(lgu))
...
def FBD_15_19(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Health Facility', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Birth (15-19 years) Done in a Health Facility in {} (2012-2021)'.format(option_table))
...
def Home_10_14(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Home', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Home Deliveries (10-14 years) in {} (2012-2021)'.format(lgu))
...
def Home_15_19(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Home', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Home Deliveries (15-19 years) in {} (2012-2021)'.format(option_table))
...
def Others_10_14(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Others', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Birth (10-14 years) Done Neither in a<br>Health Facility nor at Home in {} (2012-2021)'.format(lgu))
...
def Others_15_19(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Others', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Birth (15-19 years) Done Neither in a<br>Health Facility nor at Home in {} (2012-2021)'.format(option_table))
...
def Not_Stated_10_14(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Not Stated', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Birth (10-14 years) Not Classified as to<br>Where the Delivery Occurred in {} (2012-2021)'.format(lgu))
...
def Not_Stated_15_19(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Not Stated', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Birth (15-19 years) Not Classified as to<br>Where the Delivery Occurred in {} (2012-2021)'.format(lgu))
...
def FBD_bar_10_19(df, lgu, yrange=[0, 120]):
    fig_bar = px.bar(df.loc[df['LGU']==lgu,:], x='Year', y='Health Facility', template='seaborn',
                 ...
                 title='Adolescent Birth (10-19 years) Done in a Health Facility in {}<br>(2012-2021, Actual Count)'.format(lgu))
...
def FBD_pct_bar_10_19(df, lgu, yrange=[0, 100]):
    fig_bar = px.bar(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Health Facility', template='seaborn',
                 color='Age Range', barmode='group',
                 title='Adolescent Birth (10-19 years) Done in a Health Facility in {}<br>(2012-2021, Percent)'.format(lgu))
...
def Home_bar_10_19(df, lgu, yrange=[0, 120]):
    fig_bar = px.bar(df.loc[df['LGU']==lgu,:], x='Year', y='Home', template='seaborn',
                 color='Age Range', barmode='group',
                 title='Adolescent Home Deliveries (10-19 years) in {}<br>(2012-2021, Actual Count)'.format(lgu))
...
def Home_pct_bar_10_19(df, lgu, yrange=[0, 100]):
    fig_bar = px.bar(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Home', template='seaborn',
                 color='Age Range', barmode='group',
                 title='Adolescent Home Deliveries (10-19 years) in {}<br>(2012-2021, Percent)'.format(lgu))
...
FBD_bar_10_19(df=maternal_all, lgu='Samar', yrange=[0, 1200])
FBD_pct_bar_10_19(df=maternal_all, lgu='Samar')
Home_bar_10_19(df=maternal_all, lgu='Samar', yrange=[0, 1200])
Home_pct_bar_10_19(df=maternal_all, lgu='Samar')
...
FBD_bar_10_19(df=occurrence_all, lgu='Samar', yrange=[0, 1200])
FBD_pct_bar_10_19(df=occurrence_all, lgu='Samar')
Home_bar_10_19(df=occurrence_all, lgu='Samar', yrange=[0, 1200])
Home_pct_bar_10_19(df=occurrence_all, lgu='Samar')
