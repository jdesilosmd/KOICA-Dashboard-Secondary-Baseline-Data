...
def SBA_10_14(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent SBA', template='seaborn',
                                 ...
                                 title='Adolescent Birth (10-14 years) Performed by a<br>Skilled Birth Attendant (SBA)<br>in {} (2012-2021)'.format(lgu))
...
def SBA_15_19(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent SBA', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Birth (15-19 years) Performed by a<br>Skilled Birth Attendant (SBA) <br>in {} (2012-2021)'.format(option_table))
...
def TBA_10_14_forecast(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent TBA', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Birth (10-14 years)) Performed by a<br>Traditional Birth Attendant (TBA) <br>in {} (2012-2021)'.format(lgu))
...
def TBA_15_19(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent TBA', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Birth (15-19 years)) Performed by a<br>Traditional Birth Attendant (TBA) <br>in {} (2012-2021)'.format(option_table))
...
def Others_10_14(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Others', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Birth (10-14 years) Performed Neither by an<br>SBA nor a TBA <br>in {} (2012-2021)'.format(lgu))
...
def Others_15_19(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Others', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Birth (15-19 years) Performed Neither by an<br>SBA nor a TBA <br>in {} (2012-2021)'.format(option_table))
...
def Not_Stated_10_14(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Not Stated', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Birth (10-14 years) Not Classified as to<br>Who Performed the Delivery <br>in {} (2012-2021)'.format(lgu))
...
def Not_Stated_15_19(df, lgu):
    fig = px.scatter(df.loc[df['LGU']==lgu,:], x='Year', y='Percent Not Stated', template='seaborn',
                                 trendline='ols', trendline_color_override='black',
                                 title='Adolescent Birth (15-19 years) Not Classified as to<br>Who Performed the Delivery <br>in {} (2012-2021)'.format(lgu))
...
def SBA_bar_10_19(df, lgu, yrange=[0, 120]):
    fig_bar = px.bar(df.loc[df['LGU']==lgu,:], x='Year', y='SBA', template='seaborn',
                 ...
                 title='Adolescent Birth (10-19 years) Performed by a Skilled Birth Attendant (SBA) <br>in {} (2012-2021, Actual Count)'.format(lgu))
...
def SBA_pct_bar_10_19(df, lgu, yrange=[0, 100]):
    fig_bar = px.bar(df.loc[df['LGU']==lgu,:], x='Year', y='Percent SBA', template='seaborn',
                 color='Age Range', barmode='group',
                 title='Adolescent Birth (10-19 years) Performed by a Skilled Birth Attendant (SBA) <br>in {} (2012-2021, Percent)'.format(lgu))
...
def TBA_bar_10_19(df, lgu, yrange=[0, 120]):
    fig_bar = px.bar(df.loc[df['LGU']==lgu,:], x='Year', y='TBA', template='seaborn',
                 color='Age Range', barmode='group',
                 title='Adolescent Birth (10-19 years) Performed by a Traditional Birth Attendant (TBA) <br>in {} (2012-2021, Actual Count)'.format(lgu))
...
def TBA_pct_bar_10_19(df, lgu, yrange=[0, 100]):
    fig_bar = px.bar(df.loc[df['LGU']==lgu,:], x='Year', y='Percent TBA', template='seaborn',
                 color='Age Range', barmode='group',
                 title='Adolescent Birth (10-19 years) Performed by a Traditional Birth Attendant (TBA) <br>in {} (2012-2021, Percent)'.format(lgu))
