...
tab1, tab2a, tab2b= st.tabs(['10-14 Years', '15-19 Years', 'All Age Group'])
    ...
    with st.expander('Click to see Samar sites'):
        ...
        with col4:
            if options_samar == 'Basey':
                st.write('{} Projection Population 10 to 14 years old'.format('Basey'))
            ...
            if options_samar == 'Calbayog':
                st.write('{} Projection Population 10 to 14 years old'.format('Calbayog'))
            ...
            if options_samar == 'Calbiga':
                st.write('{} Projection Population 10 to 14 years old'.format('Calbiga'))
            ...
            if options_samar == 'Catbalogan':
                st.write('{} Projection Population 10 to 14 years old'.format('Catbalogan'))
            ...
            if options_samar == 'Marabut':
                st.write('{} Projection Population 10 to 14 years old'.format('Marabut'))
            ...
            if options_samar == 'Paranas':
                st.write('{} Projection Population 10 to 14 years old'.format('Paranas'))
            ...
            if options_samar == 'San Jose De Buan':
                st.write('{} Projection Population 10 to 14 years old'.format('San Jose De Buan'))
            ...
            if options_samar == 'San Sebastian':
                st.write('{} Projection Population 10 to 14 years old'.format('San Sebastian'))
            ...
            if options_samar == 'Santa Rita':
                st.write('{} Projection Population 10 to 14 years old'.format('Santa Rita'))
            ...
            if options_samar == 'Villareal':
                st.write('{} Projection Population 10 to 14 years old'.format('Villareal'))
    ...
    with st.expander('Click to see Southern Leyte sites'):
        ...
        with col8:
            if options_sleyte == 'Bontoc':
                st.write('{} Projection Population 10 to 14 years old'.format('Bontoc'))
            ...
            if options_sleyte == 'Libagon':
                st.write('{} Projection Population 10 to 14 years old'.format('Libagon'))
            ...
            if options_sleyte == 'Liloan':
                st.write('{} Projection Population 10 to 14 years old'.format('Liloan'))
            ...
            if options_sleyte == 'Limasawa':
                st.write('{} Projection Population 10 to 14 years old'.format('Limasawa'))
            ...
            if options_sleyte == 'Maasin':
                st.write('{} Projection Population 10 to 14 years old'.format('Maasin'))
            ...
            if options_sleyte == 'Macrohon':
                st.write('{} Projection Population 10 to 14 years old'.format('Macrohon'))
            ...
            if options_sleyte == 'Malitbog':
                st.write('{} Projection Population 10 to 14 years old'.format('Malitbog'))
            ...
            if options_sleyte == 'Padre Burgos':
                st.write('{} Projection Population 10 to 14 years old'.format('Padre Burgos'))
            ...
            if options_sleyte == 'Sogod':
                st.write('{} Projection Population 10 to 14 years old'.format('Sogod'))
            ...
            if options_sleyte == 'Tomas Oppus':
                st.write('{} Projection Population 10 to 14 years old'.format('Toppus'))
...
# sleyte Sites
    ...
    with st.expander('Click to see Southern Leyte sites'):
        ...
        with col10:
            ...
            if options_sleyte == 'Tomas Oppus':
                st.write('{} Projection Population 10 to 14 years old'.format('Tomas Oppus'))
